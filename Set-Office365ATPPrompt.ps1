...
$cid = (Get-MsolPartnerContract | Out-GridView -PassThru).tenantid 
...
New-SafeAttachmentRule -SafeAttachmentPolicy $safeAttachmentsPolicyName -RecipientDomains $domains -Name $safeAttachmentsRuleName
